...
- Работаю с Go как основным языком, TypeScript на фронтенде, Java как третий стек.
...
### Веб-безопасность — программа двойного диплома
`AlmaU · Университетский курс`

- Изучение основ в рамках учебной программы: XSS, CSRF, SQL-инъекции, OSINT.
- Практические задания на понимание уязвимостей и принципов защиты веб-приложений.
...
>
> **Java как третий стек**
>
> Строю фундамент в Java: чистая OO-структура, слои DTO/Service/Repository, явные исключения, JUnit-тесты и читаемый production-ready код.
>
...
<table border="0" cellspacing="0" cellpadding="6">
  <tr>
    ...
    <td align="center">
      <img
        src="https://github-readme-stats-theta-orcin-12.vercel.app/api/top-langs/?username=rxritet&layout=compact&theme=dark&hide_border=true&bg_color=011117&title_color=A177F7&text_color=c9d1d9"
        alt="Top Languages"
        height="165"
      />
    </td>
...
> - [ ] Настроить раздельный деплой на Vercel (frontend + backend serverless).
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=timeGradient&customColorList=0,2,4,8,30&height=100&section=footer" />
</div>
