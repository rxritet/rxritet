...
<p align="justify">
Студент 2 курса Software Engineering из Алматы. Целенаправленно осваиваю Go для выхода на первую роль разработчика. Строю практические проекты на стыке frontend и backend. Ценю чёткие задачи, измеримый результат и структурированный подход к коду.
</p>
...
• Полное изучение Figma для создания UI/UX<br>
• Разработка мобильных приложений: Flutter, Kotlin, Swift<br>
• Изучение автоматизации процессов с помощью n8n системы<br>
</p>
...
- [ ] Первое мобильное функциональное приложение
